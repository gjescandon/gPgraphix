...
void setup() {
  ...
  xbob = new NoizeBob(5., 0.006, 0.3);
  ybob = new NoizeBob(5., 0.006, 0.3);
  background(0.);
...
void draw() {
  ...
  //translate( 0.1*width*xbob.getBob() , 0.1*height*ybob.getBob());
  float t0 = 1.0 * TWO_PI / cnt;
  float off = 0.5*height;
  cb.getBob();
  float rr = rr0 + height * sin (0.006*frameCount);
...
void drawCircles(float rr) {
  
  stroke(0.0);
  float sw = 100;
  float xx = xbob.getBob();
  float yy = ybob.getBob();
  strokeWeight(sw*swb.getBob());
  fill(1.);
  //pushMatrix();
  //translate(0,0,zbob.getBob());
  circle(xx,yy, rr + 3000 * cb.getBobTail(1));
  //popMatrix();
  ...
  fill(1.);
  circle(xbob.getBobTail(100), ybob.getBobTail(100), rr + 2500 * cb.getBobTail(100));
  //popMatrix();
  ...
  fill(1.);
  circle(xbob.getBobTail(200), ybob.getBobTail(200), rr + 1500 * cb.getBobTail(200));
  //popMatrix();
  ...
  fill(1.);
  circle(xbob.getBobTail(300), ybob.getBobTail(300), rr + 500 * cb.getBobTail(300));
  //popMatrix();
}
